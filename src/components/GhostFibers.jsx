...
void main() {
  ...
  vec3 backdrop = mix(vec3(0.02, 0.03, 0.05), vec3(1.0), step(0.5, uLightMode));
    ...
    try {
      ...
      const program = new Program(gl, {
        ...
        uniforms: {
          ...
          uGrain: { value: 0.03 },
          uLightMode: { value: 0 },
          uLineColor: { value: new Float32Array(hexToRgb('#1e293b')) },
          uGlowColor: { value: new Float32Array(hexToRgb('#0f172a')) }
        }
      });
      ...
      console.warn("GhostFibers WebGL notice:", err);
    }
  }, [dpr]);
